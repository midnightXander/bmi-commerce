"""
Django settings for bmi_ecommerce project.
...
ROOT_URLCONF = 'bmi_ecommerce.urls'
...
WSGI_APPLICATION = 'bmi_ecommerce.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = 'bmiecommercebuckets'
